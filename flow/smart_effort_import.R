...
if(!is.null(my_sampling$sampMap$cutResShp)){
  ...
  my_sampling$sampMap$set_ggMapFgSamp(my_sampling$rawDataFishery)
}

# Set fisheryRawIn

suppressWarnings(grid.arrange(my_sampling$fisheryBySpecie[[1]]$femalePlot[["histLfdTot"]],
                              my_sampling$fisheryBySpecie[[1]]$femalePlot[["histUtcLfd"]],
                              my_sampling$fisheryBySpecie[[1]]$femalePlot[["histUtcTot"]],
                              my_sampling$fisheryBySpecie[[1]]$femalePlot[["dotUtcSplit"]],
...
suppressWarnings(grid.arrange(my_sampling$sampMap$ggMapFgSamp,
                              my_sampling$fisheryBySpecie[[1]]$femalePlot[["spatAbsFreq"]],
                              my_sampling$fisheryBySpecie[[1]]$femalePlot[["spatRelFreq"]],
                              my_sampling$fisheryBySpecie[[1]]$femalePlot[["spatAbbTbl"]],
...
# ### Compute mixture
my_sampling$fisheryBySpecie[[1]]$calcMixDate(nAdap = 100, nSamp = 200, sexDrop = "Female")
my_sampling$fisheryBySpecie[[1]]$ggplotMcmcOut(selCompo = c("MCMC", "Key", "Birth")[1],
                                               selSex = "Female")
###
